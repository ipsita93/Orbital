...
import com.example.noq.Receipt2;
...
public class OCR2 extends Activity implements OnClickListener {
	...
	public void onBackPressed(){
		Intent returnIntent = new Intent(OCR2.this, Receipt2.class);
	...
	public void onClick(View v) {
		...
		if (fileName != null && !apiKey.equals("") && !langCode.equals("")) {
			final ProgressDialog dialog = ProgressDialog.show( OCR2.this, "Loading ...", "Converting to text ... (may take up to one minute)", true, false);
				...
				public void run() {
					...
					runOnUiThread(new Runnable() {
						...
						public void run() {
							...
							final AlertDialog.Builder alert = new AlertDialog.Builder(OCR2.this);
							// alert.setMessage(apiClient.getResponseText());
							alert.setPositiveButton(
								"OK",
								new DialogInterface.OnClickListener() {
									public void onClick( DialogInterface dialog, int id) {
										Intent goBack = new Intent(OCR2.this, Receipt1.class);
			...
			Toast.makeText(OCR2.this, "All data are required.", Toast.LENGTH_SHORT).show();
		}
	}
