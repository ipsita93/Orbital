...
import com.example.noq.Receipt3;
...
public class OCR3 extends Activity implements OnClickListener {
	...
	public void onBackPressed(){
		Intent returnIntent = new Intent(OCR3.this, Receipt3.class);
	...
	public void onClick(View v) {
		...
		if (fileName != null && !apiKey.equals("") && !langCode.equals("")) {
			final ProgressDialog dialog = ProgressDialog.show( OCR3.this, "Loading ...", "Converting to text ... (may take up to one minute)", true, false);
				...
				public void run() {
					...
					runOnUiThread(new Runnable() {
						...
						public void run() {
							...
							final AlertDialog.Builder alert = new AlertDialog.Builder(OCR3.this);
							// alert.setMessage(apiClient.getResponseText());
							alert.setPositiveButton(
								"OK",
								new DialogInterface.OnClickListener() {
									public void onClick( DialogInterface dialog, int id) {
										Intent goBack = new Intent(OCR3.this, Receipt1.class);
			...
			Toast.makeText(OCR3.this, "All data are required.", Toast.LENGTH_SHORT).show();
		}
	}
