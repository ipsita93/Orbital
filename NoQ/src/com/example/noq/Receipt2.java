...
import com.smartmobilesofware.ocrapiservice.OCR2;
...
public class Receipt2 extends Activity {
			...
			public void onClick(View arg0) {
				...
				if (validateNum(receiptNum.getText().toString())){
					...
					if (validateShop(shopName.getText().toString())){
						...
						AlertDialog.Builder toContinue = new AlertDialog.Builder(Receipt2.this);
	...
	public void onBackPressed(){
		Intent returnIntent = new Intent(Receipt2.this, Receipts.class);
	 ...
	 class GetReceiptDetails extends AsyncTask<String, String, String> {
	    ...
	    // Before starting background thread Show Progress Dialog
	     ...
	     protected void onPreExecute() {
	         super.onPreExecute();
	         pDialog = new ProgressDialog(Receipt2.this);
